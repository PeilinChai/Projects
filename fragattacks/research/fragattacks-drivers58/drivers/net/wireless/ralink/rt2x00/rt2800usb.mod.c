...
__used __section("__versions") = {
	...
	{ 0xda80bab, "rt2800_disable_radio" },
	...
	{ 0x684764c6, "rt2x00usb_register_read_async" },
	{ 0x9a6dae8c, "rt2800_process_rxwi" },
	{ 0xc3ebfb0, "skb_trim" },
	{ 0xd358444d, "skb_pull" },
	{ 0x4cf37f83, "rt2x00usb_vendor_req_buff_lock" },
	{ 0x9369fe45, "rt2800_wait_csr_ready" },
	{ 0xeb80f28, "_dev_info" },
	{ 0x23709d1f, "_dev_err" },
...
MODULE_INFO(depends, "rt2x00lib,rt2800lib,rt2x00usb,compat");
...
MODULE_INFO(srcversion, "ACDB2FD0B80A31B4EAC8298");
